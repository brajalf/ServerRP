const App = (() => {
  ...
  window.addEventListener('message', (e) => {
    ...
    if (action === 'open') {
      ...
      state.payload = pay; state.jobs = pay.jobs || {}; state.scope = pay.scope || {mode:'admin'}; applyBranding(pay.branding); applyScope(); renderAll(); show(); return
    }
    if (action === 'update') {
