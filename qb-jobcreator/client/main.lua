...
RegisterNetEvent('qb-jobcreator:client:openUI', function()
  ...
  QBCore.Functions.TriggerCallback('RaySist-Crafting:server:GetCraftingData', function(data)
    SendNUIMessage({ action = 'craftingData', payload = data or {} })
  end)
end)
...
RegisterNUICallback('getCategories', function(_, cb)
  QBCore.Functions.TriggerCallback('qb-jobcreator:server:getCategories', function(list) cb(list or {}) end)
end)
RegisterNUICallback('createCategory', function(data, cb)
  TriggerServerEvent('qb-jobcreator:server:createCategory', data)
  cb({ ok = true })
end)
RegisterNUICallback('renameCategory', function(data, cb)
  TriggerServerEvent('qb-jobcreator:server:renameCategory', data)
  cb({ ok = true })
end)
RegisterNUICallback('saveRecipe', function(data, cb)
  TriggerServerEvent('qb-jobcreator:server:saveRecipe', data.recipe)
  cb({ ok = true })
end)
RegisterNUICallback('deleteRecipe', function(data, cb)
  TriggerServerEvent('qb-jobcreator:server:deleteRecipe', data.name)
  cb({ ok = true })
end)
