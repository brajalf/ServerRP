...
RegisterNetEvent('QBCore:Client:UseItem', function(item)
    QBCore.Debug(string.format('%s triggered QBCore:Client:UseItem by ID %s with the following data. This event is deprecated due to exploitation, and will be removed soon. Check ox_inventory for the right use on this event.', GetInvokingResource(), GetPlayerServerId(PlayerId())))
    QBCore.Debug(item)
end)
