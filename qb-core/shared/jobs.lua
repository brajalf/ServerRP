...
QBShared.Jobs = {
	...
	police = {
		...
		grades = {
			...
			['4'] = { name = 'General', isboss = true, payment = 150 },
		},
	},
	ambulance = {
		label = 'EMS',
	...
	realestate = {
		...
		grades = {
			...
			['2'] = { name = 'Vendedor de negocios', payment = 100 },
	...
	burgershot = {
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = "Empleado a prueba", payment = 50 },
			['1'] = { name = "Empleado", payment = 75 },
	...
	uwu = {
		...
		offDutyPay = false,
		grades = {
            ['0'] = {name = 'Novato',payment = 50 },
			['1'] = { name = 'Empleado', payment = 75 },
			['2'] = { name = 'Vendedor Experto', payment = 100 },
			['3'] = { name = 'Vendedor Avanzado', payment = 125 },
